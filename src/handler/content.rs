...
pub fn get_article_by_aid(aid: i32) -> Uarticle {
    ...
    article_result.content = article_result.content.replace("<", "&lt;").replace(">", "&gt;");
    article_result.title = article_result.title.replace("<", "&lt;").replace(">", "&gt;");
    article_result.username = article_result.username.replace("<", "&lt;").replace(">", "&gt;");
    article_result
}
